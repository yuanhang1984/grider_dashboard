...
class Contract {
  ...
  generateCode() {
    ...
    for (let i = 0; i < dataSource.account_list.length; i++) {
      ...
      lossTotal += account.untrade_up_sell_order_loss_total;
      lossTotal += account.untrade_down_sell_order_loss_total;
      profitTotal += account.trade_up_sell_order_profit_total;
      profitTotal += account.trade_down_sell_order_profit_total;
    }
      ...
      userListTableCode += `
        <table class = "user_list_table">
          ...
          <tbody>
            ...
            <tr>
              <td>可用资产</td><td>$&nbsp;${account.margin_available}</td>
            </tr>
            <tr>
              <td>担保资金</td><td>$&nbsp;${account.margin_position}</td>
            </tr>
            <tr>
              <td>冻结资金</td><td>$&nbsp;${account.margin_frozen}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>已交易看多卖单数量</td><td>${account.trade_up_sell_order_count}&nbsp;个</td>
            </tr>
            <tr>
              <td>已交易看空买单数量</td><td>${account.trade_down_buy_order_count}&nbsp;个</td>
            </tr>
            <tr>
              <td>已交易看空卖单数量</td><td>${account.trade_down_sell_order_count}&nbsp;个</td>
            </tr>
            <tr>
              <td>非正常撤单数量</td><td>${account.cancel_abnormal_count}&nbsp;个</td>
            </tr>
            <tr>
              <td>未交易看多卖单亏损总计</td><td>$&nbsp;${account.untrade_up_sell_order_loss_total}</td>
            </tr>
            <tr>
              <td>未交易看空卖单亏损总计</td><td>$&nbsp;${account.untrade_down_sell_order_loss_total}</td>
            </tr>
            <tr>
              <td>已交易看多卖单盈利总计</td><td>$&nbsp;${account.trade_up_sell_order_profit_total}</td>
            </tr>
            <tr>
              <td>已交易看空卖单盈利总计</td><td>$&nbsp;${account.trade_down_sell_order_profit_total}</td>
            </tr>
            <tr>
              <td>最新已交易看多买单的交易时间</td><td>${account.last_trade_up_buy_order_trade_datetime.substring(5)}</td>
            </tr>
            <tr>
              <td>最新已交易看空买单的交易时间</td><td>${account.last_trade_down_buy_order_trade_datetime.substring(5)}</td>
            </tr>
            <tr>
              <td>最新已交易看多卖单的交易时间</td><td>${account.last_trade_up_sell_order_trade_datetime.substring(5)}</td>
            </tr>
            <tr>
              <td>最新已交易看空卖单的交易时间</td><td>${account.last_trade_down_sell_order_trade_datetime.substring(5)}</td>
            </tr>
            <tr>
              <td>当前合约价</td><td>$&nbsp;${account.current_contract_price}</td>
            </tr>
            <tr>
              <td>最高未交易看多下单价</td><td>$&nbsp;${account.max_high_untrade_up_buy_order_price}</td>
            </tr>
            <tr>
              <td>价格比</td><td>$&nbsp;${(account.max_high_untrade_up_buy_order_price / account.current_contract_price).toFixed(4)}</td>
            </tr>
            <tr>
              <td>最低未交易看空下单价</td><td>$&nbsp;${account.min_low_untrade_down_buy_order_price}</td>
            </tr>
            <tr>
              <td>价格比</td><td>$&nbsp;${(account.min_low_untrade_down_buy_order_price / account.current_contract_price).toFixed(4)}</td>
            </tr>
          </tbody>
        </table>
